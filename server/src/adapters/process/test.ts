...
export async function testEnvironment(
  ...
  // REFACTOR-LIF-371: adapter_ctx_context_vs_config — ctx.config is the adapter config (command, cwd); ctx.context carries the wake snapshot; test path only reads ctx.config
